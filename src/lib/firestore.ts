...
// Subscribes to incidents created on or after fromDate — pass sessionStartRef.current
// to avoid showing old reports from previous sessions (prevents startup flicker).
